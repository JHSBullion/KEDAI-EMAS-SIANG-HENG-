...
window.I18N = {
  ...
  en:{nav_home:"Home",nav_qr:"QR Code",nav_admin:"Admin",nav_members:"Members",nav_points:"Points",nav_logout:"Logout",
      ...
      login_tips_text:"Use your Supabase admin email/password (e.g. admin@shop.com / 123456).",back_home:"Back to Home",
      qr_page_title:"QR · Member Entry",qr_title:"Printable QR Code",qr_desc:"By default it generates index.html (customer scans then enters phone)",
  ...
  bm:{nav_home:"Laman Utama",nav_qr:"Kod QR",nav_admin:"Admin",nav_members:"Ahli",nav_points:"Mata",nav_logout:"Log Keluar",
      ...
      login_tips_text:"Guna emel/kata laluan admin Supabase (cth. admin@shop.com / 123456).",back_home:"Kembali ke Laman",
      qr_page_title:"QR · Kemasukan Ahli",qr_title:"Kod QR Cetakan",qr_desc:"Lalai jana index.html (pelanggan imbas kemudian masukkan telefon)",
